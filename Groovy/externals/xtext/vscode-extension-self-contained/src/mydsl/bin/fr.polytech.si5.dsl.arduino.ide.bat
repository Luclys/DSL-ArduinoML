...
@rem ##########################################################################
@rem
@rem  fr.polytech.si5.dsl.arduino.ide startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and FR_POLYTECH_SI5_DSL_ARDUINO_IDE_OPTS to pass JVM options to this script.
...
@rem Execute fr.polytech.si5.dsl.arduino.ide
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %FR_POLYTECH_SI5_DSL_ARDUINO_IDE_OPTS%  -classpath "%CLASSPATH%" org.eclipse.xtext.ide.server.ServerLauncher %CMD_LINE_ARGS%
...
:fail
rem Set variable FR_POLYTECH_SI5_DSL_ARDUINO_IDE_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%FR_POLYTECH_SI5_DSL_ARDUINO_IDE_EXIT_CONSOLE%" exit 1
exit /b 1
