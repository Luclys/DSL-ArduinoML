...
@rem ##########################################################################
@rem
@rem  aml-socket startup script for Windows
@rem
@rem ##########################################################################
...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %MYDSL_SOCKET_OPTS%  -classpath "%CLASSPATH%" fr.polytech.si5.dsl.arduino.ide.RunServer %CMD_LINE_ARGS%
